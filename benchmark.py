...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-epochs1", type=int, default=4001, help="Number of epochs to train the first stage")
    parser.add_argument("--n-epochs2", type=int, default=4001,
    ...
    bench.benchmark(lambda x, y: x**2 + y**2, func_name="x^2+y^2", trials=5)
